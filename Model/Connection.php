...
// EXEMPLOS DE USO EM OUTRAS CLASSES = use Model\Connection;
namespace Model;
...
class Connection {
    ...
    public static function getInstance(){
        ...
        try{
            // empty = vai verificar se tem algo ali
            // self:: = para acessar a variável estática stmt 
            // new PDO () = vai estabelecer a conexão com o mysql (padrão do PHP)
            if(empty(self::$stmt)){
